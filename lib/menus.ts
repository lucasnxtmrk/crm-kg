  ...
  return [
    ...
    },
    {
      ...
      menus: [
        ...
        {
          id: "salario-agencia",
          href: "/financeiro/salario-agencia",
          label: "Salário da Agência",
          active: pathname.includes("/financeiro/salario-agencia"),
          icon: "heroicons-outline:banknotes",
          submenus: [],
        },
        {
          id: "salarios-funcionarios",
          href: "/financeiro/salarios-funcionarios",
          label: "Salários dos Funcionários",
          active: pathname.includes("/financeiro/salarios-funcionarios"),
        ...
        },
        {
          ...
          label: "Despesas",
          active: pathname.includes("/financeiro/despesas"),
